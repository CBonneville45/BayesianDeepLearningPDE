...
def train_bnns(noise):
    ...
    domain_data = np.load('/BayesianDeepLearningPDE/HeatEquation/Data/RandomSensorsDataPointsNoise' + noise + '.npy', allow_pickle = True).item()
    model_save_path_bnn = '/BayesianDeepLearningPDE/HeatEquation/SavedModels/BNN_Noise' + noise + '/'

    params_init = torch.load('/BayesianDeepLearningPDE/HeatEquation/SavedModels/DNN_Noise' + noise + '/dnn_lr_0.0002_iter_30000.pt')
    ...
    np.save('/BayesianDeepLearningPDE/HeatEquation/SavedModels/BNN_Noise' + noise + '/mx.npy', mx)
    np.save('/BayesianDeepLearningPDE/HeatEquation/SavedModels/BNN_Noise' + noise + '/sx.npy', sx)
...
def train_dnns(noise):
    ...
    domain_data = np.load('/BayesianDeepLearningPDE/HeatEquation/Data/RandomSensorsDataPointsNoise' + noise + '.npy').item()
    model_save_path_dnn = '/BayesianDeepLearningPDE/HeatEquation/SavedModels/DNN_Noise' + noise + '/'
    checkpoint_path = '/BayesianDeepLearningPDE/HeatEquation/Checkpoint/'
    ...
    np.save('/BayesianDeepLearningPDE/HeatEquation/SavedModels/DNN_Noise' + noise + '/mx.npy', mx)
    np.save('/BayesianDeepLearningPDE/HeatEquation/SavedModels/DNN_Noise' + noise + '/sx.npy', sx)
