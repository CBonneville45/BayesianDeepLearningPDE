...
True_coef = np.array([0, 0, 0, -1, 0, -1, 0, 0, 0, 0, 0])
...
for noise in NoiseCases:
    ...
    data_bnn = np.load('/BayesianDeepLearningPDE/KdVEquation/Derivatives/DerivativesData/BNN_Noise' + noise + '/Derivatives_BNN_5800s_10000pt.npy', allow_pickle = True).item()
    data_dnn = np.load('/BayesianDeepLearningPDE/KdVEquation/Derivatives/DerivativesData/DNN_Noise' + noise + '/Derivatives_DNN_10000pt.npy', allow_pickle = True).item()
