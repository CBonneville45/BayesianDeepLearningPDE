...
def train_bnns(noise):
    ...
    domain_data = np.load('/BayesianDeepLearningPDE/KdVEquation/Data/RandomSensorsDataPointsNoise' + noise + '.npy', allow_pickle = True).item()
    model_save_path_bnn = '/BayesianDeepLearningPDE/KdVEquation/SavedModels/BNN_Noise' + noise + '/'

    params_init = torch.load('/BayesianDeepLearningPDE/KdVEquation/SavedModels/DNN_Noise' + noise + '/dnn_lr_0.0002_iter_30000.pt')
    ...
    np.save('/BayesianDeepLearningPDE/KdVEquation/SavedModels/BNN_Noise' + noise + '/mx.npy', mx)
    np.save('/BayesianDeepLearningPDE/KdVEquation/SavedModels/BNN_Noise' + noise + '/sx.npy', sx)
    ...
    learningBNN.trainBNN(sigma_prior = sigma_prior, sigma_noise = sigma_noise, step_size = 0.0001, num_samples = 6000)
...
def train_dnns(noise):
    ...
    domain_data = np.load('/BayesianDeepLearningPDE/KdVEquation/Data/RandomSensorsDataPointsNoise' + noise + '.npy').item()
    model_save_path_dnn = '/BayesianDeepLearningPDE/KdVEquation/SavedModels/DNN_Noise' + noise + '/'
    checkpoint_path = '/BayesianDeepLearningPDE/KdVEquation/Checkpoint/'
    ...
    np.save('/BayesianDeepLearningPDE/KdVEquation/SavedModels/DNN_Noise' + noise + '/mx.npy', mx)
    np.save('/BayesianDeepLearningPDE/KdVEquation/SavedModels/DNN_Noise' + noise + '/sx.npy', sx)
